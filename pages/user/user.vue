		...
		<view class="user-section">
			...
			<view class="user-info-box">
				<view class="portrait-box">
					<image class="portrait" :src="user.avatar || '/static/missing-face.png'" v-if="user"></image>
					<image class="portrait" src="/static/missing-face.png" v-else></image>
				</view>
				<view class="info-box">
					<text class="username" v-if="user.username">{{ user.username }}</text>
					<view class="username" v-else @click="navTo('/pages/public/login')">Hi，您未登录</view>
				</view>
			</view>
		...
		<view class="cover-container" :style="[
		 ...
		 @touchstart="coverTouchstart" @touchmove="coverTouchmove" @touchend="coverTouchend">
			...
			<view class="history-section icon">
				...
				<list-cell icon="icon-iconfontweixin" iconColor="#e07472" title="钱包充值"  @eventClick="navTo('/pages/user/recharge')" tips="您的会员还有3天过期"></list-cell>
				<list-cell icon="icon-dizhi" iconColor="#5fcda2" title="地址管理" @eventClick="navTo('/pages/address/address')"></list-cell>
				<list-cell icon="icon-share" iconColor="#9789f7" title="分享" tips="邀请好友赢10万大礼" @eventClick="navTo('/pages/user/share')"></list-cell>
				<list-cell icon="icon-pinglun-copy" iconColor="#ee883b" title="晒收益" tips="邀请列表和收益" @eventClick="navTo('/pages/user/profitList')"></list-cell>
