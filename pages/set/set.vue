<template>
	<view class="container">
		...
		<view class="list-cell" @click="navTo('/pages/user/reset_password')" hover-class="cell-hover" :hover-stay-time="50">
		...
		<view class="list-cell b-b" @click="navTo('关于土特产商城')" hover-class="cell-hover" :hover-stay-time="50">
			<text class="cell-tit">关于土特产商城</text>
			<text class="cell-more yticon icon-you"></text>
		</view>
